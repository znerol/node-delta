...
(function(exports){
     ...
     *
     * @param left  A SnakeHead marking the start-point of the calculation.
     * @param right A SnakeHead marking the last position considered in the
     *              calculation.
     */
     ...
     *
     * @param head  (Output) Reference to a SnakeHead which will be populated
     *              with the new values
     ...
     *
     * @param lefthead  (Output) A reference to a SnakeHead which will be
     *                  populated with the values corresponding to the left end
     *                  of the middle snake.
     * @param righthead (Output) A reference to a SnakeHead which will be
     ...
     *
     * @param left      Left SnakeHead
     * @param right     Right SnakeHead
    ...
    /**
     * Create a new SnakeHead instance.
     *
     * A SnakeHead represents a point identified by an x-coordinate and the
...
}(typeof exports === 'undefined' ? (this.lcs={}) : exports));
