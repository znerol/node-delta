...
(function(exports, deltamod, platform) {
    ...
    DOMDeltaAdapter.prototype.constructOperationElement = function(doc, op) {
        ...
        if (op.oldvalue != null) {
            oldcontent = this.fragmentadapter.adapt(op.oldvalue);
            if (typeof oldcontent === 'string') {
                oldvalue.appendChild(doc.createTextNode(oldcontent));
            }
            else {
        ...
        if (op.newvalue != null) {
            newcontent = this.fragmentadapter.adapt(op.newvalue);
            if (typeof newcontent === 'string') {
                newvalue.appendChild(doc.createTextNode(newcontent));
            }
            else {
