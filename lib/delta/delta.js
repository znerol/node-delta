...
(function(exports, tree) {
    ...
    Delta.prototype.attach = function(root, resolver, handlerfactory) {
        ...
        this.operations.forEach(function(op) {
            nodes = this.resolver.find(op.path, op.values, op.head, op.tail);
            ...
            switch (op.type) {
                ...
                case REMOVE_TYPE:
                    handler = this.handlerfactory.createSubtreeRemoveHandler(
                            nodes[depth - 1], nodes[depth].childidx, op.values.length);
                    break;
     ...
     */
    function Operation(type, path, values, head, tail, oldvalue, newvalue) {
        /**
