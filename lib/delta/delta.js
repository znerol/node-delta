...
(function(exports, tree) {
    ...
    Editor.prototype.update = function(path, a, b) {
        ...
        var op = new Operation(UPDATE_TYPE, path, fp.head, fp.tail, [a], [b]);
        this.delta.add(op);
    }
    ...
    Editor.prototype.insert = function(path, b_nodes) {
        ...
        var op = new Operation(INSERT_TYPE, path, fp.head, fp.tail, null, b_nodes);
        this.delta.add(op);
    }
    ...
    Editor.prototype.remove = function(path, a_nodes) {
        ...
        var op = new Operation(REMOVE_TYPE, path, fp.head, fp.tail, a_nodes, null);
        this.delta.add(op);
    }
