    ...
    Diff.prototype.matchLeafUpdates = function(matching) {
        ...
        for (i = 0; i < b_leaves.length && a_leaves.length > 0; i++) {
            ...
            for (k = 0; k < a_leaves.length; k++) {
                ...
                // Match ancestors
                result = matchNodeTopDown(matching, b.par, a.par, function(b, a) {
                ...
                // Match candidates
                // FIXME: reject updates when node-type differ
                result = matchNodeTopDown(matching, b, a, function(b, a) {
                    return leafpair || a.value === b.value;
                });
                if (!result) {
                    continue;
                }
