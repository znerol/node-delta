...
(function(exports, tree) {
    ...
    UniformDepthResolver.prototype.find = function(path, values, head, tail) {
        ...
        best = resolveByContext(best.index, generation, values, head, tail);
        return best;
    };
     ...
     */
    UniformDepthResolver.prototype.equals = function(a, b) {
        return a === b;
    }
     ...
     */
    UniformDepthResolver.prototype.resolveByContext = function(index, content,
            values, head, tail) {
        var w = new ContextWindow(content, this.r),
            best,       // Offset of the candidate with the best match
        ...
        w.forEach(index, values.length, head.length, tail.length, function(
                    cand_values, cand_head, cand_tail, offset) {
            var i, f = 0;
