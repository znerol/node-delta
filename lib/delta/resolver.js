...
(function(exports, tree) {
    ...
    ContextResolver.prototype.find = function(path, body, head, tail) {
        ...
        if (node) {
            ...
            for (i = -this.r; i <= this.r; i++) {
                f = this.matcher.matchContent(i, function(offset, patnode) {
                    var cand = this.nodeindex.get(node, offset);
                    return this.equalContent(cand, patnode);
                }, this);
                if (f !== 1) {
                    continue;
                }
    ...
    {
        return this.matchContent(offset, test, T) &&
            this.matchContext(offset, test, T);
    };
