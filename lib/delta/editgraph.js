...
(function(exports){
    function Editgraph(a, b, left, right, dmax) {
        this.a = a;
        this.b = b;
    ...
    Editgraph.prototype.limit = function(left, right, dmax) {
        ...
        this.right = (typeof right !== 'undefined') ? right :
            new SnakeHead(this.a.length, this.left.k + this.a.length - this.b.length);
            ...
            for (k = -d; k <= d; k+=2) {
                ...
                if (delta % 2 === 1 && k >= -d-1+delta && k <= d-1+delta) {
                    if (Vf[k] >= Vb[k]) {
                        ...
                        snake.left = new SnakeHead(this.left.x + Vf[k0], this.left.k + k0);
                        snake.right = head;
                        return d;
                    }
                }
            ...
            for (k = -d+delta; k <= d+delta; k+=2) {
                ...
                if (delta % 2 === 0 && k >= -d && k <= d) {
                    if (Vf[k] >= Vb[k]) {
                        ...
                        snake.left = head;
                        snake.right = new SnakeHead(this.left.x + Vb[k0], this.left.k + k0);
                        return d;
                    }
                }
            }
