...
(function(exports){
     ...
     * Middle snake
     */
    Editgraph.prototype.middleSnake = function (lefthead, righthead, onhead, T) {
        var d, k, head, k0;
        var delta = this.delta;
        var Vf = {};
        var Vb = {};
            ...
            for (k = -d; k <= d; k+=2) {
                ...
                if (delta % 2 === 1 && k >= -d-1+delta && k <= d-1+delta) {
                    if (Vf[k] >= Vb[k]) {
                        ...
                        lefthead.x = this.left.x + Vf[k0];
                        lefthead.k = this.left.k + k0;
            ...
            for (k = -d+delta; k <= d+delta; k+=2) {
                ...
                if (delta % 2 === 0 && k >= -d && k <= d) {
                    if (Vf[k] >= Vb[k]) {
                        ...
                        righthead.x = this.left.x + Vb[k0];
                        righthead.k = this.left.k + k0;
                        // return the number of iterations of the outer loop
                        return d;
                    }
                }
    ...
    Editgraph.prototype.compute = function(editor) {
        var M = this.M,
            ...
            middle = new Snake(midleft, midright),
            head,
            tail,
            d;
