var docdiff = require('../lib/delta/docdiff');
...
/**
 * Tree a and tree b do not have any leaf-values in common. However document
 * structure is equal in both trees.
 */
exports["should match common structure even if no leaf nodes match"] = function(test) {
    var a = new tree.Node('r');
    var a1 = new tree.Node('n');
    var a11 = new tree.Node('x');
    var b = new tree.Node('r');
    var b1 = new tree.Node('n');
    var b11 = new tree.Node('y');
